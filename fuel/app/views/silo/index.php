...
<div class="row animated fadeInUp">
		...
		<?php foreach ($silos as $item): ?>		<tr>
					...
					<td><?php echo $capacity_rate[$item->id]."%"; ?></td>
...
(function(){
    ...
    var datagauge = ['data', 95];
    	data = {};
    	data.data1 = <?=  $capacity_rate[1] ;?> ;
    	data.data2 =  <?= $capacity_rate[2] ;?>;
    ...
    channel.bind('prodreport', function(data) {
      ...
      console.log('PushNotification',data.message + ' '+data.name);
       var datagauge1 = ['data', data.data1] || <?=  $capacity_rate[1] ;?>,
           datagauge2 = ['data', data.data2] || <?=  $capacity_rate[2] ;?>,
           datapie1   = ['data1', data.data1] || ['data1', <?=  $capacity_rate[1] ;?>],
           datapie2   = ['data2', data.data2] || ['data2', <?=  $capacity_rate[2] ;?>]
           ;
	...
	$(document).ready(function () {
            ...
            c3.generate({
                ...
                data:{
                    columns: [
                        ['data1', <?=  $capacity_rate[1] ;?>],
                        ['data2', <?=  $capacity_rate[2] ;?>]
                    ],
                    colors:{
                        data1: '#1ab394',
                        data2: '#BABABA'
